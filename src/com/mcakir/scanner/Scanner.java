...
public class Scanner {
    ...
    public void scan() throws Exception {
        ...
        if(logging) write2File(dilated, "E:\\summer\\Esraa\\learning\\bubble-sheet-multiple-choice-scanner\\sources\\step_1_dilated.png");

        gray = new Mat(dilated.size(), CV_8UC1);
        cvtColor(dilated, gray, COLOR_BGR2GRAY);
        if(logging) write2File(gray, "E:\\summer\\Esraa\\learning\\bubble-sheet-multiple-choice-scanner\\sources\\step_2_gray.png");

        thresh = new Mat(gray.rows(), gray.cols(), gray.type());
        threshold(gray, thresh, 150, 255, THRESH_BINARY);
        if(logging) write2File(thresh, "E:\\summer\\Esraa\\learning\\bubble-sheet-multiple-choice-scanner\\sources\\step_3_thresh.png");

        blur = new Mat(gray.size(), CV_8UC1);
        blur(gray, blur, new Size(5., 5.));
        if(logging) write2File(blur, "E:\\summer\\Esraa\\learning\\bubble-sheet-multiple-choice-scanner\\sources\\step_4_blur.png");

        canny = new Mat(blur.size(), CV_8UC1);
        Canny(blur, canny, 160, 20);
        if(logging) write2File(canny, "E:\\summer\\Esraa\\learning\\bubble-sheet-multiple-choice-scanner\\sources\\step_5_canny.png");
        ...
        if(logging) write2File(adaptiveThresh, "E:\\summer\\Esraa\\learning\\bubble-sheet-multiple-choice-scanner\\sources\\step_6_adaptive_thresh.png");
...
//            double childId = ids[2];
        ...
        if(logging) write2File(source.submat(roi), "E:\\summer\\Esraa\\learning\\bubble-sheet-multiple-choice-scanner\\sources\\step_7_roi.png");
    }
    ...
    private void findBubbles() throws Exception {
        ...
        System.out.println(canny.submat(roi).size());
